...
def sendData(number):  
    try: 
        ...
        WriteToFile("Can not send data to Camera 1!")
        Error = messagebox.showerror(title='LỖI', message= 'Không thể gửi bản tin tới Camera trước! \n Vui lòng kiểm tra lại dây cắm Camera!')
        raise
...
def sendDataToCam2(number):
    try: 
        ...
        WriteToFile("Can not send data to Camera 2!")
        Error = messagebox.showerror(title='LỖI', message= 'Không thể gửi bản tin tới Camera sau! \n Vui lòng kiểm tra lại dây cắm Camera!')
        raise
...
def getDataPackage():
    try:
        ...
        WriteToFile("Can not get data from Camera!")
        res = "No Data"
        return res
# get id
...
def getDoorStatusCam1():
    ...
    try:
        ...
        WriteToFile('Can not get front door Status!')
        return 'No Data'
...
def getDoorStatusCam2():
    ...
    try:
        ...
        WriteToFile('Can not get rear door Status!')
        return 'No Data'
